...
const sideStats = computed(() => [
  ...
  { label: '检测样品量', value: `${Number((overview.value.sampleCount || 0) + (overview.value.selfDetectionSampleCount || 0))}` },
  { label: '检测项次', value: `${Number((overview.value.detectionItemCount || 0) + (overview.value.selfDetectionItemCount || 0))}` },

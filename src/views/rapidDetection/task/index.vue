            ...
            <div class="query-form-wrapper">
                <el-form :model="queryParams" ref="queryRef" :inline="true" class="custom-query-form custom-query-form-row">
                    ...
                    <el-form-item label="" prop="taskName">
                        <el-input :prefix-icon="Search" v-model="queryParams.taskName" placeholder="搜索任务编号或任务名称"
                            class="custom-input w220" clearable />
                    </el-form-item>
                    <el-form-item label="">
            ...
            <div class="content-card">
                <div class="table-wrapper">
                    <el-table v-loading="loading" :data="tableData" border="false">
                        ...
                        <el-table-column label="任务名称" prop="taskName" align="center" min-width="200" show-overflow-tooltip />
                        ...
                        <el-table-column label="状态" prop="status" align="center" width="100">
                            <template #default="{ row }">
                                <span :class="['status-tag', row.status === '进行中' ? 'status-processing' : 'status-completed']">
                                    {{ row.status }}
                                </span>
                            </template>
                        </el-table-column>
                    ...
                    <div class="pagination-wrapper">
                        <pagination v-show="total > 0" :total="total" v-model:page="pagination.pageNum"
                            v-model:limit="pagination.pageSize" layout="prev, pager, next" @pagination="fetchData"
